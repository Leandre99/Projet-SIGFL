...
import bj.mef.sigfl_backend.shared.domain.exception.DomainException;
...
/**
 * Translates exceptions into the normalised {@link ApiError} JSON payload so
 * every module returns consistent error responses.
 */
